...
class MeetingRequest(forms.Form):
    ...
    contact_no = forms.IntegerField(max_value=9999999999, label="Contact Number", widget=forms.NumberInput(attrs={'placeholder': 'Enter mobile number', 'class': 'personalDetails'}))
